    ...
    return(
        <Segment clearing>
                ...
                <Form.Input placeholder='Venue' value={activity.venue} name='venue' 
                    onChange={handleInputChange} />
                <Form.Input placeholder='Available' value={activity.available} name='available' 
                    onChange={handleInputChange} />
                <Form.Input placeholder='Price' value={activity.price} name='price' 
                    onChange={handleInputChange} />
                <Button loading={loading} floated='right' positive type='submit' content='Submit' />
                <Button as={Link} to='/services' floated='right' type='button' content='Cancel' />
                <Button  floated='right' type='button' content='Edit' />
